...
export const instructorDbRepository = (
    ...
    const checkRejected = async (instructorId: string) => await repository.checkRejected(instructorId);


    const rejectInstructorRequest = async (  instructorId: string, reason: string ) => await repository.rejectInstructorRequest(instructorId, reason);
