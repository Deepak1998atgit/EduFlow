...
const CONFIG_KEYS = {
  GOOGLE_AUTH_CLIENT_ID:"366805472610-nv9njm2827m6kkmdqcbadqn7tuk4979a.apps.googleusercontent.com" as string,
  ...
  API_BASE_URL: "http://localhost:5000" as string,  //netstat -ano | findstr "4000"
  };
