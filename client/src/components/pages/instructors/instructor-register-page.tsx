...
import SpinnerDialog from "../../common-components/spinner-page";
const initialValues = {
  firstName: "",
  lastName: "",
  email: "",
...
const InstructorRegistrationPage: React.FC = () => {
  ...
  return (
    <div className='mt-4 pl-32 pr-32 my-3 pb-5  text-customFontColorBlack  bg-gradient-to-r from-[#005AA7] to-[#FFFDE4]'>
      <div className='flex items-center justify-center'>
        {isUploading && <SpinnerDialog isUploading={isUploading} />}
        <div className=' w-2/3 bg-white ml-2 mt-6 mb-8 border p-10 shadow-xl rounded-lg'>
