...
const StudentHero: React.FC = () => {
    return (
        <>
            <section id="home" className="flex items-center justify-center  flex-col gap-4 pt-20 pl-10 pr-10 h-screen">
                {/* <ParticlesComponent/> */}
                <div className="h-full w-full bg-gradient-to-br from-[#566c45] to-[#dfefe4]  rounded-br-[200px] lg:p-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full ">
                        ...
                        <div>
                            ...
                            {/* </div> */}
                            <div className="w-full h-full flex flex-col items-center lg:items-start justify-center mt-0">
